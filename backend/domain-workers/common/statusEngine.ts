...
const REQUEST_TRANSITIONS: Record<RequestStatus, RequestStatus[]> = {
  CREATED: ['COLLECTED', 'LAB_QUEUE', 'ON_HOLD', 'DISCREPANCY', 'CANCELLED', 'REJECTED'],
  COLLECTED: ['LAB_QUEUE', 'VERIFICATION', 'ON_HOLD', 'DISCREPANCY', 'CANCELLED'],
  LAB_QUEUE: ['VERIFICATION', 'CALIBRATION', 'ON_HOLD', 'FAULTY', 'OUTSOURCED', 'CANCELLED'],
  VERIFICATION: ['CALIBRATION', 'LAB_QUEUE', 'ON_HOLD', 'DISCREPANCY', 'FAULTY', 'CANCELLED'],
