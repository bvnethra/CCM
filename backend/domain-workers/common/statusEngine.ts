...
const ITEM_TRANSITIONS: Record<RequestItemStatus, RequestItemStatus[]> = {
  ...
  LAB_QUEUE: ['RECEIVED_IN_LAB', 'VERIFICATION', 'CALIBRATION', 'FAULTY', 'OUTSOURCED', 'CANCELLED'],
  RECEIVED_IN_LAB: ['VERIFICATION', 'CALIBRATION', 'LAB_QUEUE', 'FAULTY', 'OUTSOURCED', 'CANCELLED'],
